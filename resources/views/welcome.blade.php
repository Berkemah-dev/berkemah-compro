...
@section('content')
@if (session('success'))
<div class="px-4 section-shell pt-28 sm:px-6 lg:px-8">
    <div class="px-5 py-4 border shadow-sm rounded-2xl border-slate-200 bg-slate-50 text-slate-800">
        {{ session('success') }}
    </div>
</div>
@endif

<section id="home" class="relative pt-24 overflow-hidden" data-reveal>
    <div class="absolute inset-0">
        <img src="{{ asset('assets/1271a5023ed8f830ff48e66f80e086f5.jpg') }}" alt="Latar Berkemah" class="object-cover w-full h-full" />
        <div class="absolute inset-0 bg-slate-950/55"></div>
    </div>

    <div class="relative px-4 pt-20 pb-20 section-shell sm:px-6 lg:px-8 lg:pb-24">
        <div class="max-w-4xl">
            ...
            <p class="max-w-2xl mt-6 text-lg leading-relaxed text-slate-100 copy-justify">Berkemah lahir pada 2023 dari tim kecil yang ingin membuat software operasional yang benar-benar enak dipakai. Kami membangun Mahya HRIS dan Mahya HSE untuk membantu perusahaan mengurangi kerja manual, memperjelas alur approval, dan menjaga proses harian tetap rapi dari awal sampai selesai.</p>
            <div class="flex flex-wrap gap-4 mt-10">
                <a href="/#journey" class="inline-flex items-center px-6 py-3 text-sm font-semibold transition bg-white rounded-full text-slate-900 hover:bg-slate-100">Lihat Perjalanan Kami</a>
                <a href="/#products" class="inline-flex items-center px-6 py-3 text-sm font-semibold text-white transition border rounded-full border-white/60 bg-white/10 hover:bg-white/20">Lihat Produk</a>
            </div>
        </div>
    </div>
</section>
...
<section id="vision-mission" class="page-section bg-slate-50" data-reveal>
    <div class="section-shell">
        <div class="text-center">
            ...
            <p class="mx-auto section-lead copy-justify">Arah kami bukan sekadar membuat software terlihat modern, tapi memastikan software itu benar-benar membantu proses kerja harian, dari input data sampai approval dan pelaporan.</p>
        </div>

        <div class="grid gap-6 mt-12 lg:grid-cols-2">
            <article class="border-l-4 trust-card border-slate-500">
                <div class="inline-flex items-center justify-center w-12 h-12 mb-4 border rounded-2xl border-slate-200 bg-slate-50 text-slate-700" aria-hidden="true">
                ...
                <p class="mt-4 leading-8 text-slate-600 copy-justify">Kami ingin setiap tim bisa menjalankan proses SDM dan keselamatan kerja secara terstruktur, terukur, dan mudah dipantau oleh manajemen tanpa menambah beban administrasi.</p>
            </article>

            <article class="border-l-4 trust-card border-slate-400">
                <div class="inline-flex items-center justify-center w-12 h-12 mb-4 border rounded-2xl border-slate-200 bg-slate-50 text-slate-700" aria-hidden="true">
                    <svg viewBox="0 0 24 24" class="w-6 h-6" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="mt-4 leading-8 text-slate-600 copy-justify">Setiap fitur kami rancang agar mengurangi kerja manual, mempercepat keputusan operasional, dan meningkatkan kualitas koordinasi antar tim yang selama ini sering tersendat karena data tersebar.</p>
            </article>
        </div>
    </div>
</section>
        ...
        <div class="grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-start">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="trust-card">
                    <div class="inline-flex items-center justify-center w-10 h-10 mb-3 rounded-2xl bg-slate-50 text-slate-700" aria-hidden="true">✦</div>
...
<section id="journey" class="page-section bg-slate-50" data-reveal>
    <div class="section-shell">
        <div class="text-center">
            ...
            <p class="mx-auto section-lead copy-justify">Dari fondasi kecil sampai pengembangan produk yang matang, setiap fase kami fokus pada kebutuhan operasional yang nyata dan bisa langsung dirasakan manfaatnya.</p>
        </div>

        <div class="mt-12 timeline-wrap">
...
<section id="products" class="text-white page-section bg-slate-950" data-reveal>
    <div class="section-shell">
        <div class="text-center">
            <h2 class="text-3xl font-black tracking-tight md:text-5xl">Produk Berkemah</h2>
            <p class="max-w-3xl mx-auto mt-4 text-slate-300 copy-justify">Dirancang untuk kebutuhan operasional perusahaan: cepat dipahami, stabil dijalankan, dan siap dipakai tim berkembang yang butuh hasil nyata, bukan sekadar tampilan bagus.</p>
        </div>

        <div class="grid gap-6 mt-12 lg:grid-cols-2">
            <a href="{{ route('mahya.hris') }}" class="p-8 transition border group rounded-3xl border-blue-400/30 bg-slate-900 hover:-translate-y-1 hover:border-blue-300">
                <div class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                            <span class="inline-flex items-center justify-center w-12 h-12 overflow-hidden border rounded-xl border-blue-300/50 bg-blue-500/20" aria-hidden="true">
                                <img src="{{ asset('assets/logo-mahya.png') }}" alt="" class="object-cover w-full h-full">
                            </span>
                        <div>
                ...
                <div class="flex flex-wrap gap-2 mt-6">
                    <span class="px-3 py-1 text-sm border rounded-full border-slate-600 text-slate-200">Absensi</span>
                    <span class="px-3 py-1 text-sm border rounded-full border-slate-600 text-slate-200">Payroll</span>
                    <span class="px-3 py-1 text-sm border rounded-full border-slate-600 text-slate-200">Approval</span>
                    <span class="px-3 py-1 text-sm border rounded-full border-slate-600 text-slate-200">Master Data</span>
                </div>
            </a>

            <a href="{{ route('mahya.hse') }}" class="p-8 transition border group rounded-3xl border-green-400/30 bg-slate-900 hover:-translate-y-1 hover:border-green-300">
                <div class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                        <span class="inline-flex items-center justify-center w-12 h-12 text-green-200 border rounded-xl border-green-300/50 bg-green-500/20" aria-hidden="true">
                            <svg viewBox="0 0 24 24" class="w-6 h-6" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-wrap gap-2 mt-6">
                    <span class="px-3 py-1 text-sm border rounded-full border-slate-600 text-slate-200">Checklist</span>
                    <span class="px-3 py-1 text-sm border rounded-full border-slate-600 text-slate-200">Incident</span>
                    <span class="px-3 py-1 text-sm border rounded-full border-slate-600 text-slate-200">Audit</span>
                    <span class="px-3 py-1 text-sm border rounded-full border-slate-600 text-slate-200">Compliance</span>
                </div>
            </a>
        </div>
    </div>
...
<section id="hris-benefits" class="page-section bg-slate-50" data-reveal>
    <div class="section-shell">
        <div class="text-center">
            ...
            <p class="mx-auto section-lead copy-justify">Bukan hanya fitur, tetapi kemudahan implementasi dan kejelasan operasional yang jadi pembeda utama ketika perusahaan mulai memilih solusi yang tepat.</p>
        </div>

        <div class="grid gap-6 mt-12 lg:grid-cols-2">
            <article class="border-l-4 trust-card border-slate-500">
                <div class="inline-flex items-center justify-center w-10 h-10 mb-3 rounded-2xl bg-slate-50 text-slate-700" aria-hidden="true">HR</div>
            ...
            <article class="border-l-4 trust-card border-slate-400">
                <div class="inline-flex items-center justify-center w-10 h-10 mb-3 rounded-2xl bg-slate-100 text-slate-700" aria-hidden="true">≠</div>
...
<footer class="py-12 border-t border-slate-200 bg-slate-50">
    <div class="px-4 section-shell sm:px-6 lg:px-8">
        ...
        <div class="pt-6 mt-10 text-sm text-center border-t border-slate-200 text-slate-700">
